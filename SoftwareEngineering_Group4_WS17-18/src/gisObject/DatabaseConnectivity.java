		...
		try{
			...
			if (rs!=null){
				while (rs.next()) {                     //start loop to save results
					...
					DrawingPanel.shapes.add(new ShapeItems (rs.getString("name") , new Point(s[0], s[1]), new Color(Integer.parseInt(color[0]),Integer.parseInt(color[1]),Integer.parseInt(color[2]))));
				}
			}
			else{
				stm.close();
		...
		try{
			...
			if (rs!=null){
				while (rs.next()) {                     //start loop to save results
					...
					DrawingPanel.shapes.add(new ShapeItems (rs.getString("name") , new Line2D.Double(s[0], s[1], s[2], s[3]), new Color(Integer.parseInt(color[0]),Integer.parseInt(color[1]),Integer.parseInt(color[2]))));
				}
			}
			else{
				stm.close();
		...
		try{
			...
			if (rs!=null){
				while (rs.next()) {                     //start loop to save results
					...
					System.out.println(arr);
					Double [] s = (Double[])arr.getArray();
					DrawingPanel.shapes.add(new ShapeItems (rs.getString("name") , new Rectangle2D.Double(s[0], s[1], s[2], s[3]), new Color(Integer.parseInt(color[0]),Integer.parseInt(color[1]),Integer.parseInt(color[2]))));
				}
			}
			else{
				stm.close();
		...
		try{
			...
			if (rs!=null){
				while (rs.next()) {                     //start loop to save results
					...
					DrawingPanel.shapes.add(new ShapeItems(rs.getString("name") , path , new Color(Integer.parseInt(color[0]),Integer.parseInt(color[1]),Integer.parseInt(color[2]))));
				}
			}
			else{
				stm.close();
