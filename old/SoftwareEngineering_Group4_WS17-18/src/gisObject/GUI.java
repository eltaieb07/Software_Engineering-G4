...
public class GUI extends JFrame{
	...
	DrawingPanel panel;  //DrawingPanel class, every thing happening here in this panel
	DatabaseConnectivity dc; 
	FileHandling fh; 
	private JPanel p; // this panel used as a container to hold the Jtree of the geometry properties
	private JPanel p2; // this panel is used to hold the functionalities buttons
	...
	public GUI(){
		...
		ImageIcon icon = new ImageIcon("..\\SoftwareEngineering_Group4_WS17-18\\icons\\frame.png");
		...
		ImageIcon icon_open = new ImageIcon("..\\SoftwareEngineering_Group4_WS17-18\\icons\\openfile.png");
